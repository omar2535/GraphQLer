...
class Fuzzer(object):
    ...
    def __run_chain(self, chain: Chain):
        ...
        Each chain is fully self-sufficient (generated by :class:`AllDependenciesChainStrategy`),
        so its bucket starts completely empty — no objects from previous chains are copied in.
